...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\csandrade\projeto\ecommerce\ambiente_ecommerce'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\csandrade\projeto\ecommerce\ambiente_ecommerce\Scripts\deactivate.nu'
